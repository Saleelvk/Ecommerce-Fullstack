...
import close1 from "../assets/image/communication/outline/close.png"
import logo from "../../public/image/letter-g_12452164.png" 
import Discount from "./discount";
import  search  from "../../public/image/search 02.png";
import cart from "../../public/image/shopping bag.png"
import profile from "/public/image/Vector.png"
import menu from "../../src/assets/image/menu_open_43dp_5F6368_FILL0_wght400_GRAD0_opsz40.png"
function Navbar() {
  ...
  <div className="fixed top-0 left-0 w-full h-full bg-black bg-opacity-50 z-40">
    ...
    >
      ...
      <button
          ...
          >
          <img src={close1} alt=""  className="w-6"/>
        </button>
        </div>
        {cartItems.map((item) => (
