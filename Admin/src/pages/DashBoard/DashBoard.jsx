...
import dashboard from "/image/Dashboard/Iconn.png"
import dashboard2 from  "/image/Dashboard/Icon-1.png"
import dashboard3 from  "/image/Dashboard/Icon.png"
function DashBoard() {
      ...
      <div className="lg:ml-72 pt-8 pb-5 px-5"> {/* Added padding for smaller screens */}
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3"> {/* Responsive grid for stats cards */}
          <div className="px-8 py-6 flex justify-between bg-white rounded-xl shadow-md">
            ...
            <div>
              <img src={dashboard} alt="Total Users Icon" />
            </div>
          </div>
          ...
          <div className="px-8 py-6 flex justify-between bg-white rounded-xl shadow-md">
            ...
            <div>
              <img src={dashboard2} alt="Total Orders Icon" />
            </div>
          </div>
          ...
          <div className="px-8 py-6 flex justify-between bg-white rounded-xl shadow-md">
            ...
            <div>
              <img src={dashboard3} alt="Total Products Icon" />
            </div>
          </div>
        </div>
